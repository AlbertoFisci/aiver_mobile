...
class WizardSessionePage extends StatelessWidget {
  const WizardSessionePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: SharedAppBar(title: l10n.menu_crea_sito),
      drawer: const SharedDrawer(),
      body: const Center(
        child: Text('Wizard creazione sito/cantiere - Placeholder'),
      ),
    );
  }
}
